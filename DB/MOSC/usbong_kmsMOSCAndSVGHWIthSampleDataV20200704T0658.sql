...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2020 at 12:58 AM
...
`treatment_id` int(11) NOT NULL,
  ...
  `treatment_temperature` decimal(10,0) NOT NULL,
...
--
ALTER TABLE `treatment`
ADD CONSTRAINT `treatment_ibfk_1` FOREIGN KEY (`treatment_id`) REFERENCES `transaction` (`transaction_id`);
