...
INSERT INTO `x_ray_service` (`x_ray_service_id`, `x_ray_body_location_id`, `x_ray_type_id`, `x_ray_price`) VALUES
(1, 1, 6, 600),
(2, 2, 14, 400),
(3, 3, 2, 350),
(4, 3, 6, 600),
...
--
ALTER TABLE `x_ray_service`
MODIFY `x_ray_service_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=41;
--
