...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2025 at 08:45 AM
...
CREATE TABLE `cashier` (
  ...
  `cashier_name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
...
CREATE TABLE `lab_service` (
  ...
  `lab_service_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `added_datetime_stamp` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `medical_technologist` (
  ...
  `medical_technologist_name` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `report` (
  ...
  `report_filename` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `security` (
  ...
  `security_inbound` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `note` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
