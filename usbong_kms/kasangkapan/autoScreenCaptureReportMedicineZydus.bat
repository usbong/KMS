...
REM @date updated: 20220801; from 20220721
REM
REM Reference:
...
phantomjs saveWebPageAsImageFile.js "confirmMedicine/_postaldren"
phantomjs saveWebPageAsImageFile.js "confirmMedicine/_postetoxi-60" 
