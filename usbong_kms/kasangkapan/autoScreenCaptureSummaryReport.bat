@ECHO OFF
REM
REM Copyright 2020~2022 SYSON, MICHAEL B.
REM
...
REM @date created: 20220111
REM @date updated: 20220111
...
phantomjs saveWebPageAsImageFile.js viewSummaryReportForEndDay -s 192.168.11.55
