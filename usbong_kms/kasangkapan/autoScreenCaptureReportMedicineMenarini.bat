...
REM @date updated: 20220815; from 20220801
REM
REM Reference:
...
phantomjs saveWebPageAsImageFile.js "confirmMedicine/_postfastum"
phantomjs saveWebPageAsImageFile.js "confirmMedicine/_postketesse" 
