@echo off
REM
REM Copyright 2021-2026 USBONG
REM 
...
REM @date updated: 20260326; from 20250215
...
REM edited by Mike, 20260326; from 20250215
REM phantomjs saveWebPageAsImageFile.js "confirmMedicine" 
REM phantomjs saveWebPageAsImageFile.js "confirmMedicineBoxesLeft/_postlagaflex" 
phantomjs saveWebPageAsImageFile.js "confirmMedicineBoxesLeft/_postvexer" 
