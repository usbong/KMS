...
REM @date updated: 20220818; from 20220816
REM
REM Reference:
...
phantomjs saveWebPageAsImageFile.js "confirmMedicine/_postxuvan" 
phantomjs saveWebPageAsImageFile.js "confirmMedicine/_postresidron"
