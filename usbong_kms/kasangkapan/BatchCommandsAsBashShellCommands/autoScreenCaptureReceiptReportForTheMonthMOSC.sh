...
# 3) put phantomjs executable file in the same directory as Bash Shell command, e.g. autoScreenCapturerReceiptReportForTheMonthMOSC.sh
# --> example: /opt/lampp/htdocs/usbong_kms/kasangkapan

./phantomjs saveWebPageAsImageFile.js viewReceiptReport
