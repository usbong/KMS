...
//										echo $value['transaction_id'];
								...
								//edited by Mike, 20201127; edited again by Mike, 20211022
...
//									$iTransactionId = $iTransactionIdMax;
									...
									$iTransactionId = $iTransactionId -1;
//									$iTransactionId = $iTransactionId -2;
//									$iTransactionId = $iTransactionId +1;
								}									
...
/* //edited by Mike, 20211022
											...
											$myNetFeeValue = $value['fee']*0.70 - $value['fee']*0.12;
*/											
											//TO-DO: -reverify: this due to $value now uses incorrect transactionId
											$myNetFeeValue = $value['fee']*0.70 - $value['fee']*0.12;
