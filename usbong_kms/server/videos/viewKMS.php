<!--
  ...
  1) local: http://localhost/usbong_newsletters/server/videos/viewKMS.php  
  2) public internet: http://store.usbong.ph/server/videos/viewKMS.php
...
-->
	...
	<br/>
	<a class="webServiceLink" href="https://github.com/usbong/KMS" target="_blank">
	KNOWLEDGE MANAGEMENT SYSTEM</a>
	<br/>
	<br>	
	<div>
		<b>DATABASE KNOW-HOW: Example Work Output</b><br/>
<!--
...
-->
		...
		<b><a class="webServiceLink" href="https://www.usbong.ph/excel" target="_blank">COMPUTER SOFTWARE AUTOMATION</a>: Example Work Output</b> <br/>
		...
		<video width="416" height="312" controls>
		  <source src="assets/images/videos/exampleWeeklyCashCollectionReportWithComputerAutomationAssistanceUsingLibreOfficeCalcMacroBasic20220306T0949.mp4" type="video/mp4">
		  Your browser does not support the video tag.
		</video><br/>	
...
<br/>
		...
		<b><a class="webServiceLink" href="https://www.usbong.ph/excel" target="_blank">COMPUTER NETWORK</a>: Example Work Output</b> <br/>
		<br/>
		<video width="416" height="312" controls>
		  <source src="assets/images/videos/exampleRJ45CableHeadCorrectlyBuiltToCauseLEDBlinkingPattern20220225T1523.mp4" type="video/mp4">
		  Your browser does not support the video tag.
		</video><br/>	
