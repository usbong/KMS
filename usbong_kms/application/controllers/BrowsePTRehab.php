...
class BrowsePTRehab extends CI_Controller { //MY_Controller {
...
*/		
	...
	public function confirmPatientInformationDeskSVGH()
	{
		...
		//added by Mike, 20200328
		if (!isset($data['nameParam'])) {
			redirect('browsePTRehab/searchPatientInformationDeskSVGH');
		}
		...
		$data['medicalDoctorList'] = $this->BrowsePTRehab_Model->getMedicalDoctorList();
	
		//edited by Mike, 20200601
		//$data['result'] = $this->Browse_Model->getDetailsListViaName($data);		
		$data['result'] = $this->BrowsePTRehab_Model->getNewestPatientDetailsListViaName($data);		
