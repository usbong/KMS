...
?>		
	...
	<?php	
		//$imageResult = [];
		$imageResult = ['synapse20200828.png', 'synapseSet2-20200828.png', 'synapseSet3-20200828.png', 'synapseSet4DX-20200828.png'];
		//array_push($imageResult
...
-->
									<img class="Image-file" src="<?php echo base_url("photographs/".$value);?>">
								</div>								
							</a>
						</td>
					  </tr>
