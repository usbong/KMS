...
'
' Note:
' 1) We already include the Value-Added Tax (VAT) in the price.
'
' Recommendation:
' 1) We only use integer values, i.e. whole numbers.
-->
<?php
	...
	<table class="imageTable">
	  <tr>
		...
		<td class="pageNameColumn">
			<h2>
				Report Today (Unified)<br />Purchased Non-medicine
			</h2>		
		</td>
	  </tr>
	</table>
...
//								echo $value['fee'];
								...
								//added by Mike, 20200430; edited by Mike, 20200610
								//note: automatically include the VAT
/*								
								$fFee = 0;
