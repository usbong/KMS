...
' @author: Michael Syson
  ...
  @date updated: 20220216; from 20210501
  ...
  1) At present, use this web address to access the page to store the reports in the DB.
	...
	.../usbong_kms/index.php/report/storeReportImageOnly
...
?>	
	...
	<br/>
	<form id="myFormId" enctype="multipart/form-data" method="post" action="<?php echo site_url('image/confirmStoreImageOnly/0');?>"> <!--$result[0]['transaction_id']-->
