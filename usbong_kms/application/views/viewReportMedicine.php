...
' @date updated: 20220629; from 20210110
	...
	<table class="imageTable">
	  <tr>
		...
		<td class="pageNameColumn">
			<h2>
				Report Today<br />Purchased Medicine 
			</h2>		
		</td>
	  </tr>
	</table>
...
<?php				
		...
		?>				
					  ...
					  <tr class="row">
						...
						<td class ="column">	
							<!-- edited by Mike, 20220629 -->
							<a target='blank_' href='<?php echo site_url('browse/viewItemMedicine/'.$value['item_id'])?>' id="viewItemId<?php echo $iCount?>">
								<div class="itemName">
				<?php
