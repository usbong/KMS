...
' @date updated: 20211215; FROM 20200722
'
' Note:
' 1) component parts from viewPatientSLHCC
-->
<?php
...
//			alert(medicalDoctorId);
			...
			window.location.href = "<?php echo site_url('browseSLHCC/addTransactionServicePurchaseSLHCC/"+therapistId+"/"+patientId+"/"+scheduleDate+"/"+scheduleTime+"/"+diagnosis+"/"+temperature+"/"+bloodPressure+"');?>";
		}	
...
//			window.location.href = "<?php echo site_url('browseSLHCC/deleteTransactionFromPatient/"+transactionId+"');?>";
			window.location.href = "<?php echo site_url('browseSLHCC/deleteTransactionFromPatientSLHCC/"+patientId+"/"+transactionId+"');?>";
	...
	<table class="imageTable">
	  <tr>
		<td class="imageColumn">				
			...
			<img class="Image-SLHCCLogo" src="<?php echo base_url('assets/images/SLHCCLogo.png');?>">	
		</td>
		<td class="pageNameColumn">
			<h2>
<!--			//edited by Mike, 20200717		
				Search Patient<br/>@SLHCC
-->
				Search Patient Names<br/>@
				<a href='<?php echo site_url('reportSLHCC/viewReportPatientAppointmentList/')?>'>
					Information Desk (SLHCC)
				</a>
	...
	<!-- Form -->
	<!-- edited by Mike, 20200717 -->
	<form id="browse-form" method="post" action="<?php echo site_url('browseSLHCC/confirmPatientInformationDeskSLHCC')?>">
		<?php
			$itemCounter = 1;
		?>
...
*/	
		...
		?>				
					  ...
					  <tr class="row">
						<td class ="column">				
							<!-- edited by Mike, 20200713 -->
							<a href='<?php echo site_url('browseSLHCC/viewPatientSLHCC/'.$value['patient_id'])?>' id="viewPatientId<?php echo $iCount?>">
