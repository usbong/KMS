...
' @date updated: 20260915; from 20260909
...
*/			
		...
		//added by Mike, 20200331; edited by Mike, 20201211
...
//			window.location.href = "<?php echo site_url('browse/payTransactionItemPurchase/3/"+itemId+"/"+patientId+"');?>";
			...
			window.location.href = "<?php echo site_url('browse/payTransactionItemPurchase/3/"+itemId+"/"+patientId+"/"+medicalDoctorId+"');?>";
					  ...
					  <tr class="row">
						<td class ="column">				
							<a href='<?php echo site_url('browse/viewItemSnack/'.$value['item_id'])?>' id="viewItemId<?php echo $iCount?>">
								...
								<?php //edited by Mike, 20260915 to remove the extra space after the item name;
...
//edited by Mike, 20210622							
	...
	//									$iQuantity =  1;
						...
						<td class ="columnFee">				
								<div id="cartItemQuantityId<?php echo $iCount?>" class="cartItemQuantityDiv">
							<?php
/*							
								if ((isset($cartValue['patient_name'])) && ($cartValue['patient_name']!=="NONE")) {
									$iQuantity =  1;
