...
-->
		<input type="hidden" name="reportTypeNameParam" value="Reports from All Locations" required>

<!--		<input style="font-size: 52px;" id="uploadFilesId" name="reportParamUploadFiles" type="file" multiple="multiple" accept="text/plain" onInput="showAlert();"/>
-->
		<input style="font-size: 52px;" id="uploadFilesId" name="reportParamUploadFiles[]" type="file" multiple="multiple" accept="text/plain" onInput="showAlert();"/>
