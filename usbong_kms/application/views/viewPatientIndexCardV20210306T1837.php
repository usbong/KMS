...
<!-- added by Mike, 20210224 -->
	...
	?>		
			...
			<td class="ageAnswerColumn">
				<input class='inputText' type='text' name='inputTextAgeName' placeholder='10' required>
			</td>
			<td class ="columnTableHeader">				
				<?php
					echo "GENDER";
			...
			<td class ="columnTableHeader">				
				<select id="genderParam" class="gender-select">
