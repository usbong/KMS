<!--
  ...
  @date updated: 20260729; from 20260630
...
*/
				if ($value['fee']!=0) {
					echo "<tr>";
						...
						echo "</td>";			
						echo "<td class='column'>";
						//edited by Mike, 20260630; from 20250324
						
						//echo "<b>PROF FEE: DR. ".$value['medical_doctor_name']."</b>";
						
						$sMedicalDoctorName="";
						if (isset($arrayMedicalDoctorName[$mdCount])) {
							$sMedicalDoctorName=$arrayMedicalDoctorName[$mdCount];
						}
