...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	/**/
						...
						{
							text-align: left;
							color: #0000ff; <!-- added by Mike, 20200817 -->
						}
...
*/
  ...
  <body>
	...
	<br/>
	<!-- Form -->
	<form id="browse-form" method="post" action="<?php echo site_url('browselite/confirmNonMedicineLite')?>">
		<?php
			$itemCounter = 1;
		?>
