...
*/
		...
		if ((strpos(strtoupper($param['nameParam']),"NONE")!==false)
			...
			//added by Mike, 20210723
			$this->db->select('t1.patient_name, t1.patient_id, t2.transaction_id, t2.transaction_date, t2.fee, t2.transaction_type_name, t2.treatment_type_name, t2.treatment_diagnosis, t2.notes, t3.medical_doctor_id, t3.medical_doctor_name');
