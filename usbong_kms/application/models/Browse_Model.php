...
*/			
			...
			//$this->db->not_like('t2.notes', 'IN-QUEUE; PAID');
...
//		$row = $query->row();		
		...
		$iCountTotal = count($rowArray);
		if ($iCountTotal>1) {			
			//echo count($rowArray);	
			//echo $rowArray[1]['notes'];
...
/*	//removed by Mike, 20250507
	...
	public function getMedicalDoctorIdViaTransactionId($transactionId) 
	{		
		$this->db->select("medical_doctor_id");
