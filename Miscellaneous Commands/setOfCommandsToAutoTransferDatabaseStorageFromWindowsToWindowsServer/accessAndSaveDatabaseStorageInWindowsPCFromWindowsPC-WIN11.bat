...
REM @last modified: 20231206; from 20230517
REM @website address: www.usbong.ph
REM

REM notes: WINDOWS 11; date format variation;

REM edited by Mike, 20231206; from 20230207
REM set myDate=%date:~10,4%%date:~4,2%%date:~7,2%
set myTime=%time:~0,2%%time:~3,2%

REM echo %myTime%
REM 06/12/2023
REM echo "raw date: "%date% 
REM echo "date year: "%date:~6,4% 
REM echo "date month: "%date:~3,2%
REM echo "date day: "%date:~0,2%
...
set source="\\halimbawa_unit\MOSC\DB"
