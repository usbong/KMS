...
# @last modified: 20220304; from 20201001
#
# References:
...
sudo mkdir /mnt/myMOSC-AccountingFolderFromLinux/

#update source location
#source: from Windows machine, e.g. Windows 7, Service Pack 1
#Example:
#source="//192.168.11.10/accounting/"
#source="//192.168.11.10/information desk/"
#source="sftp://192.168.11.43/home/unit_member/informationDeskLinux/"
source="unit_member@192.168.11.43:/home/unit_member/informationDeskLinux/"
...
destination="/mnt/myMOSC-AccountingFolderFromLinux/"

echo "destination: "$destination

#Note: add quotation marks, e.g. in $source
#TO-DO: add: auto-read from external file password=halimbawaValue
#note: used to access Windows machine
#sudo mount -t cifs "$source" "$destination" -o user=unit_member
#sudo sshfs unit_member@USBONG-MACHINE:/ $destination
#sudo sshfs unit_member@192.168.11.43:/home/unit_member/ $destination
sudo sshfs $source $destination
