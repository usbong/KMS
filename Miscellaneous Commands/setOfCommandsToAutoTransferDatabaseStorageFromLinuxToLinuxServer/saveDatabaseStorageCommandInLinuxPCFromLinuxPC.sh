...
# @last modified: 20220304; from 20201009
...
#source="./mnt/myMOSC-AccountingFolderFromLinux/*"
#source="./*" #Desktop
#source="InformationDeskLinux/*"
source="/mnt/myMOSC-AccountingFolderFromLinux/InformationDeskLinux/*"
...
destination="/home/unit_member/Documents/halimbawaLinuxOnly/"
...
#where: t = keep time
#where: v = verbose
sudo rsync -rtv $source $destination
